...
float ArmMath_CalcTime(const ArmJoint *start, const ArmJoint *end)
{
    ...
    max_delta = fmaxf(max_delta,
                      fabsf(angle_diff(end->wrist, start->wrist)));
